...
# import imitation.envs.examples.multiagent_particle_envs.make_env:make_env as make_particle_env
...
def make_vec_env(
    ...
    def make_env(i, this_seed):
        ...
        if no_done:  # using time limit as terminal condition
            env = spec.make(no_done=no_done, max_episode_length=max_episode_steps)
        else:
            env = spec.make()
...
def init_rl(
    ...
    **model_kwargs,
    ...
    all_kwargs = {"verbose": 1, "tensorboard_log": None}
