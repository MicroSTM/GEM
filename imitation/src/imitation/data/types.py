...
from imitation.data import old_types, IRL_types
...
def load(path: str) -> Sequence[TrajectoryWithRew]:
    ...
    if len(trajectories) > 0:
        ...
        # print('type',type(trajectories[0]))
        if isinstance(trajectories[0], IRL_types.Trajectory):
            trajectories = [
                TrajectoryWithRew(traj.obs, traj.acts, traj.infos, traj.rews)
